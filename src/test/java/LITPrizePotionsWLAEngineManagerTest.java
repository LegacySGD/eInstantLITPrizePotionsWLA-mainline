...
public class LITPrizePotionsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITPrizePotionsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITPrizePotionsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITPrizePotionsWLAIW/InitOutcome.xml").getDocumentElement();
